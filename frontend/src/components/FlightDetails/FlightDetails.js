      ...
      <Typography color="textPrimary" component="span">
        <Grid>
          <Box component="div" m={2}>
            ...
            <TextField margin="normal" label="Label" name="scheduledDeparture" fullWidth value={state.data.scheduledDeparture} />
            <TextField margin="normal" label="Label" name="actualDeparture" fullWidth value={state.data.actualDeparture} />
            <TextField margin="normal" label="Label" name="scheduledArrival" fullWidth value={state.data.scheduledArrival} />
            <TextField margin="normal" label="Label" name="actualArrival" fullWidth value={state.data.actualArrival} />
